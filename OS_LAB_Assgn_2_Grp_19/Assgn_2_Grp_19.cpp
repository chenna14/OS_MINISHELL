...
string join_cmd(vector<string> tokens)
{
    string cmd;
...
string expand_wildcards(string cmd)
{
...
vector<int> get_pids_with_file(const std::string &file_path)
{
    vector<int> pids;
